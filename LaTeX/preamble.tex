...
\WithSuffix\newcommand \bigFourier*[1]{\mathcal{F}^{-1} \big[ #1 \big]} % inverse Fourier transform for big expressions
\WithSuffix\newcommand \BigFourier*[1]{\mathcal{F}^{-1} \Big[ #1 \Big]} % inverse Fourier transform for Big expressions

\newcommand{\Laplace}[1]{\mathcal{L} [#1]} % Laplace transform
\newcommand{\bigLaplace}[1]{\mathcal{L} \big[ #1 \big]} % Laplace transform for big expressions
\newcommand{\BigLaplace}[1]{\mathcal{L} \Big[ #1 \Big]} % Laplace transform for Big expressions
\newcommand{\BiggLaplace}[1]{\mathcal{L} \Bigg[ #1 \Bigg]} % Laplace transform for Big expressions
\WithSuffix\newcommand \Laplace*[1]{\mathcal{L}^{-1} [#1]} % inverse Laplace transform
\WithSuffix\newcommand \bigLaplace*[1]{\mathcal{L}^{-1} \big[ #1 \big]} % inverse Laplace transform for big expressions
\WithSuffix\newcommand \BigLaplace*[1]{\mathcal{L}^{-1} \Big[ #1 \Big]} % inverse Laplace transform for Big expressions
\WithSuffix\newcommand \BiggLaplace*[1]{\mathcal{L}^{-1} \Bigg[ #1 \Bigg]} % inverse Laplace transform for Bigg expressions
