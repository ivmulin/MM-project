...
%Подставляя $\alpha ^2 = \frac{1}{20}$, получаем ответ
%\begin{align*}
%u(x, t) = \dfrac{1-x}{2} \bigg[ \erf \bigg( \sqrt{ \dfrac{5}{t} } x \bigg) & - \erf \bigg( \sqrt{ \dfrac{5}{t} } (x-1) \bigg) \bigg] -\\
%& - \sqrt{ \dfrac{t}{20\pi} } \bigg[ \exp \bigg( -\dfrac{5x^2}{t} \bigg) - \exp \bigg( -\dfrac{5(x-1)^2}{t} \bigg)  \bigg].
%\end{align*}
